    ...
    useEffect(() => {
        const fetchNotifications = async () => {
            try {
                ...
                const unreadIds = data.filter(e => !e.read).map(e => e.id);
                    ...
                    <ScrollArea className="h-[calc(100vh-12rem)]">
                        {notifications.length === 0 ? (
                            ...
                            notifications.map((notification) => (
                                ...
                                >
                                    <Image
                                        src={notification.creator.image ?? 'https://cdn-icons-png.flaticon.com/512/6596/6596121.png'}
                                        alt={`${notification.creator.name}_Avatar`}
                                        width={45}
                                        height={45}
